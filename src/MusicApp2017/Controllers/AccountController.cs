...
namespace MusicApp2017.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> Index(RegisterViewModel registerVM, string returnUrl = null)
        {
            var currentUser = await _userManager.GetUserAsync(User);

            registerVM.Email = currentUser.Email;
            registerVM.GenreID = currentUser.GenreID;
